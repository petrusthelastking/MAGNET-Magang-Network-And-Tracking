...
$resetEditData = function () {
    $this->editData = [
        'tanggal' => $this->logMagang->tanggal ? $this->logMagang->tanggal->format('Y-m-d') : null,
        'jam_masuk' => $this->logMagang->jam_masuk ? $this->logMagang->jam_masuk->format('H:i') : null,
        'jam_keluar' => $this->logMagang->jam_keluar ? $this->logMagang->jam_keluar->format('H:i') : null,
...
$calculateDuration = computed(function () {
    if (!$this->logMagang || !$this->logMagang->jam_masuk || !$this->logMagang->jam_keluar) {
        return null;
    }
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if ($logMagang)
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    @else
                        <div class="flex space-x-3">
                            <flux:button wire:click="saveEdit" variant="primary" icon="check">
                                Simpan
                            </flux:button>
                            <flux:button wire:click="cancelEdit" variant="outline" icon="x-mark">
                                Batal
                            </flux:button>
                        </div>
                    @endif
                            ...
                            @else
                                <div class="space-y-4">
                                    <flux:field>
                                        ...
                                        <flux:input wire:model="editData.tanggal" type="date" />
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900">
                                    {{ $logMagang->kontrakMagang->lowonganMagang->nama ?? '-' }}
                                </p>
                            </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <flux:button wire:click="goBack" variant="primary">
