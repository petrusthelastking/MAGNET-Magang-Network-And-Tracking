<x-layouts.user.main user="admin">
    <flux:breadcrumbs class="mb-5">
        ...
        <flux:breadcrumbs.item href="{{ route('admin.aturan-magang') }}" class="text-black">Aturan Magang
    ...
    <div class="space-y-6">
        ...
        <div id="aturan-magang-content" class="bg-white rounded-lg shadow-sm border p-8">
            ...
            <div class="text-center pt-6 border-t">
                <p class="text-sm text-gray-600">
                    ...
                    <strong>Ketua Jurusan Teknologi Informasi</strong><br>
