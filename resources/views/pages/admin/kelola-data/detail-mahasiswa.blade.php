            ...
            <div class="card-body">
                ...
                <div class="flex flex-col gap-4">
                    <flux:field>
                        ...
                        @else
                            <flux:input value="{{ $nama }}" wire:model="nama" readonly class="caret-transparent" />
                        @endif
                    ...
                    <flux:field>
                        ...
                        @else
                            <flux:input value="{{ $nim }}" wire:model="nim" readonly class="caret-transparent" />
                        @endif
                        <flux:error name="nim" />
                    </flux:field>
                    ...
                    <flux:field>
                        ...
                        @else
                            <flux:input value="{{ $jurusan }}" wire:model="jurusan" readonly class="caret-transparent" />
                        @endif
                    ...
                    <flux:field>
                        ...
                        <flux:select placeholder="Program Studi Anda" wire:model="program_studi">
                            ...
                            <flux:select.option value="D2 Pengembangan Piranti Lunak Situs">D2 Pengembangan Piranti Lunak Situs</flux:select.option>
                        </flux:select>
                        @else
                    ...
                    <flux:field>
                        ...
                        @else
                            <flux:input value="{{ $angkatan }}" wire:model="angkatan" readonly class="caret-transparent" />
                        @endif
                    ...
                    <flux:field>
                        ...
                        @else
                            <flux:input value="{{ $umur }} tahun" wire:model="umur" readonly class="caret-transparent" />
                        @endif
