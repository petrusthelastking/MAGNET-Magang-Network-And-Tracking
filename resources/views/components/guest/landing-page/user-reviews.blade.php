<section class="min-h-screen flex flex-col items-center justify-center" id="partner">
    <h1 class="text-center text-2xl font-bold mb-8">Apa kata mereka tentang MAGNET?</h1>

    <!-- Baris 1: ke kanan -->
    <div class="overflow-hidden w-full mb-6">
        <div class="flex animate-scroll-horizontal" style="width: max-content;">
            <!-- Set 1 -->
    ...
    <div class="overflow-hidden w-full">
        <div class="flex animate-scroll-horizontal-reverse" style="width: max-content;">
            <!-- Set 1 -->
            <div class="flex gap-4">
                <div class="bg-white rounded-xl p-4 w-80 shadow-md flex-shrink-0">
                    <div class="flex items-center gap-4">
